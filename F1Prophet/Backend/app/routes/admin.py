    ...
    try:
        ...
        for prediction in predictions:
            ...
            if old_points > 0:
                ...
                if user:
                    user.total_points -= old_points
                    old_points_removed += old_points
        ...
        for result in actual_results:
            ...
            is_fastest_lap = (
                result['driver_id'] == actual_fastest_lap
            )
        ...
        for prediction in predictions:
            ...
            new_points = points_breakdown['total_points']
            ...
            user_points_updates[user_id] += new_points
        ...
        return jsonify({
            ...
            'old_points_removed': old_points_removed
        }), 200
